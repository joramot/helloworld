...
**Hello Microverse Project. Jose RM.** In this project, I set up a "Hello world" repository. I applied the tools and best practices that I learned about in previous steps.

## 🛠 Built With <a name="Visual Studio Code">HTML5 & CSS3</a>
...
Clone this repository to your desired folder:
  ...
  cd "your-folder"
  git clone git@github.com:https://github.com/joramot/hello-world.git
